...
2. Save the Rocketmiles.jar file to a folder on your computer and take note of that folder's path (something like 'C:\Users\yourName\Documents\Rocketmiles')
3. Start Windows Command Prompt (Windows Key -> Run -> cmd) 
4. In Windows Prompt, change directory to the path, where the jar files is located, the path that you noted in step 2. (cd C:\Users\yourName\Documents\Rocketmiles)
